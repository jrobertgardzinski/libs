package com.jrobertgardzinski.email.specification.gmail;
...
import com.jrobertgardzinski.email.domain.GmailNormalizationPolicy;
import com.jrobertgardzinski.email.specification.GmailAliasSpecification;
...
class GmailNormalizationPolicyTest {
    ...
    private final EmailFactory gmailFactory = new EmailFactory(new GmailAliasSpecification());
    private final EmailFactory rfcFactory   = new EmailFactory(new RfcFormatSpecification());
